...
function CustomFileBrowser(field_name, url, type, win) {
    ...
    // $('textarea#id_geom').addClass('mceNoEditor');
...
tinyMCE.init({
    ...
    // Init
    // mode: 'specific_textareas',  // if editor_selector : "mceEditor"
    // mode: 'textareas',
    selector : 'textarea:not(#id_geom,#id_chart,[id$="chart"])',
    // elements : "id_geom",
    // selector: "#myid",
    theme: 'advanced',
    skin: 'grappelli',
    ...
    editor_deselector: 'mceNoEditor,[id$="chart"]',
    keep_styles: false,
    language: 'en',
    object_resizing: false,
    plugins: 'table,advimage,advlink,fullscreen,paste,media,searchreplace,grappelli,template,lists',
    ...
    style_formats: [
        ...
        {title: 'Красный цвет', block : 'span', classes: 'text-danger'},
        {title: 'Главный цвет', block : 'span', classes: 'text-primary'},
        {title: 'Второй цвет', block : 'span', classes: 'text-slug'}
    ],
    verify_html: false,
    ...
    content_css : "/static/css/iadmin.css",

    // Theme Advanced
    theme_advanced_toolbar_location: 'top',
    theme_advanced_toolbar_align: 'left',
    theme_advanced_statusbar_location: 'bottom',
    theme_advanced_buttons1: 'formatselect,styleselect,|,bold,italic,underline,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,|,outdent,indent,|,link,unlink,|,media,table,code,image,|,fullscreen,',
    //theme_advanced_buttons1: 'undo,redo,|,link,unlink,|,image,|,fullscreen,|,grappelli_adv',
